...
<div class="modal fade" id="reservationModal" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Reservierung wurde erfolgreich ausgef&uuml;hrt. Es wurde
					Ihnen eine Mail gesendet, in dieser Sie weitere Informationen
					erhalten.</p>
			</div>
		</div>
	</div>
...
<form onsubmit="checkForm()">
	...
	<div class="row">
		<div class="col" style="text-align: center">
			<input type="button" class="btn btn-default btn-lg showcase-btn2"
				id="btnOnWhite" style="margin-bottom: 15px" onclick="checkForm()"
