...
public class DaoController {
	...
	public void setReservation(int id, String newStartDate, String newEndDate, String email, String firstName,
			String lastName, String phone) throws SQLException, InterruptedException, ParseException {

		try (Connection con = Dao.getInstance().getConnection()) {
			Statement stmt = con.createStatement();
			stmt.executeUpdate("INSERT INTO reservation " + "VALUES(" + id + ", '" + newStartDate + "', '" + newEndDate
	...
	public void setReservationItem(int id, int reservationId, int bikeId, int amount)
			throws SQLException, InterruptedException, ParseException {

		try (Connection con = Dao.getInstance().getConnection()) {
			Statement stmt = con.createStatement();
			stmt.executeUpdate("INSERT INTO reservationitem " + "VALUES(" + id + ", " + reservationId + ", " + bikeId
					+ ", " + amount + ")");
		} catch (SQLException e) {
			e.printStackTrace();
		}
