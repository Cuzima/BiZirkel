...
public class MailServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String msg = "<!DOCTYPE html>\r\n" + "<html lang=\"de\">\r\n" + "<head>\r\n" + "<meta charset=\"utf-8\" />\r\n"
				...
				+ "			style='width: 100%'>\r\n" + "		<h2>Reservierungsnummer: #" + reservationId
				+ "</h2>\r\n" + "\r\n" + "		<h4>Vielen Dank " + lastName + " " + firstName
				+ " für Ihre Reservierung bei\r\n" + "			BiZirkel.</h4>\r\n" + "		<br>\r\n"
		...
		// setup mail for BiZirkel employees
